...
struct VentaView: View {
    ...
    @State var inputRecurso: String = ""
    @State var inputCoins: String = "0"
    ...
    @StateObject var ventaViewModel: VentaViewModel = VentaViewModel()
        ...
        VStack {
            ZStack {
                Form {
                    ...
                    Section("1 \(selectedRecurso) = \(precioPorUnidad) coins") {
                            ...
                            HStack(spacing: 8) {
                                ...
                                TextField("0", text: $inputRecurso)
                                    ...
                                    .onChange(of: inputRecurso) { newValue in
                                        ...
                                        botonDisabled = cantidad > recursosUser || cantidad == 0 || coins == 0
                                        hasExceededBalance = cantidad > recursosUser
                                    }
                                    .overlay(
                                        Text("-")
                                            .foregroundColor(.gray)
                ...
                // Botón de confirmación
                    ...
                    VStack{
                        ...
                        HStack {
                            ...
                            if hasExceededBalance {
                                //IMPLEMENTACION FUTURA EN EL CASO DE QUERER HACER ALGO SI EXCEDE EL BALANCE
                                /*
                                Button() {
                                    
                                    
                                } label: {
                                    Label("Comprar \(selectedRecurso)", systemImage: "plus.circle")
                                ...
                                */
                                ...
                                Button() {
                                    botonLoading = true
                                    ventaViewModel.getVenta(gasto: inputRecurso, tipo: selectedRecurso, incremento: inputCoins)  { respuesta in
                                        
                                        if (respuesta == "OK") {
                                            realizarVenta(recurso: selectedRecurso)
                                    ...
                                    Label("Confirmar venta", systemImage: "hand.tap.fill")
                                        .foregroundStyle(Color.white)
                                        .padding()
            ...
            .alert("👍 Venta realizada con éxito", isPresented: $mostrarMensajeOK) {
                Button("OK", action: {})
            } message: { Text("") }
    ...
    func getPointsInfo () -> String {
        return "\(puntosTotales) → \(puntosTotales - (Int(inputCoins) ?? 0)) puntos"
    }
    ...
    func realizarVenta(recurso: String) {
        let ahora = Date()
